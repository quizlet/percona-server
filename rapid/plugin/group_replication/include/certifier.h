...
public:
  ...
  */
  ...
  /**
    ...
    broadcast.
  */
  static const int BROADCAST_PERIOD= 60; // seconds
...
public:
  ...
  */
  ...
  /**
    ...
    @param[in] member_id the member_id which sent the message
  ...
  */
  ...
  rpl_gno get_and_increment_sequence_number();
