...
static PSI_mutex_info all_group_replication_psi_mutex_keys[]=
{
  ...
  {&key_GR_LOCK_leave_coordinator, "LOCK_leave_coordinator", PSI_FLAG_GLOBAL}
};
...
static PSI_rwlock_info all_group_replication_psi_rwlock_keys[]=
{
  ...
  {&key_GR_RWLOCK_io_cache_map , "RWLOCK_io_cache_map", PSI_FLAG_GLOBAL},
  {&key_GR_RWLOCK_io_cache_map_clear , "RWLOCK_io_cache_map_clear", PSI_FLAG_GLOBAL},
