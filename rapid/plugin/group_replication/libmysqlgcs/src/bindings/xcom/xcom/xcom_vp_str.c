...
char *delivery_status_to_str(delivery_status x)
{
    switch(x){
    case delivery_ok:
        return "delivery_ok";
...
char *cons_type_to_str(cons_type x)
{
    switch(x){
    case cons_majority:
...
char *cargo_type_to_str(cargo_type x)
{
    switch(x){
...
char *recover_action_to_str(recover_action x)
{
    switch(x){
    case rec_block:
        return "rec_block";
...
char *pax_msg_type_to_str(pax_msg_type x)
{
    switch(x){
    case normal:
        return "normal";
...
char *client_reply_code_to_str(client_reply_code x)
{
    switch(x){
    case REQUEST_OK:
        return "REQUEST_OK";
...
char *xcom_proto_to_str(xcom_proto x)
{
    switch(x){
