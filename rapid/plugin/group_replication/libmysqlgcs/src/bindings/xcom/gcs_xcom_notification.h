...
typedef void (xcom_receive_data_functor)(synode_no, node_set, u_int, char *);
/**
...
typedef void (xcom_global_view_functor)(synode_no, synode_no, node_set);
/**
...
typedef void (xcom_local_view_functor)(synode_no, node_set);
/**
...
public:
  /**
    ...
    @param functor: Pointer to a function that contains that actual
                    core of the execution.
    @param message_id: Messaged Id.
    @param nodes: Set of nodes that were defined when the notification
                  happened.
  */
