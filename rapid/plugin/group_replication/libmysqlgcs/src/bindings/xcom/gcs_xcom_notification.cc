...
Data_notification::Data_notification(xcom_receive_data_functor *functor,
  ...
  : m_functor(functor), m_message_id(message_id), m_nodes(nodes),
...
{
  (*m_functor)(m_message_id, m_nodes, m_size, m_data);
}
...
{
  (*m_functor)(m_config_id, m_message_id, m_nodes);
}
...
{
  (*m_functor)(m_message_id, m_nodes);
}
