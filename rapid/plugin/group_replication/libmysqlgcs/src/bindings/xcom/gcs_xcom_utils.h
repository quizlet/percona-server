...
public:
  ...
  */
  ...
  static std::string *build_xcom_member_id(std::string &address);
...
public:
  ...
  */
  ...
  virtual int
  xcom_client_add_node(connection_descriptor* fd, node_list *nl, unsigned long group_id)= 0;
  ...
  */
  ...
  virtual int xcom_client_remove_node(node_list *nl, unsigned long group_id)= 0;
  ...
  /**
    ...
    - int xcom_client_remove_node(node_list *nl, unsigned long group_id)
  ...
  */
  ...
  virtual int xcom_init(int listen_port)= 0;
  ...
  */
  ...
  virtual int xcom_init_ssl(const char *server_key_file, const char *server_cert_file,
                            const char *client_key_file, const char *client_cert_file,
                            const char *ca_file, const char *ca_path,
                            const char *crl_file, const char *crl_path,
                            const char *cipher, const char *tls_version)= 0;
  ...
  */
  ...
  virtual int xcom_client_boot(node_list *nl, unsigned long group_id)= 0;
  ...
  */
  ...
  virtual connection_descriptor* xcom_client_open_connection(std::string addr, int port)= 0;
  ...
  */
  ...
  virtual bool xcom_open_handlers(std::string saddr, int port)= 0;
...
public:
  ...
  int xcom_client_add_node(connection_descriptor* fd, node_list *nl, unsigned long group_id);
  int xcom_client_remove_node(connection_descriptor* fd, node_list* nl, unsigned long group_id);
  int xcom_client_remove_node(node_list *nl, unsigned long group_id);
  int xcom_client_boot(node_list *nl, unsigned long group_id);
  connection_descriptor* xcom_client_open_connection(std::string, int port);
  int xcom_client_close_connection(connection_descriptor* fd);
  int xcom_client_send_data(unsigned long long size, char *data);
  int xcom_init(int listen_port);
  ...
  bool xcom_open_handlers(std::string saddr, int port);
  ...
  int xcom_client_force_config(node_list *nl, unsigned long group_id);
